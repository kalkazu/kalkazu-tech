...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  services: "Website" | "App" | "Graphic Design" | "Shopify" | "Wordpress";
  info: string;
  terms: boolean;
};
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="items-center justify-center  w-full">
                      <FormLabel className="text-sm bg-opacity-50">
                        First name *
                      </FormLabel>
                      <FormControl>
                        <Input {...field} />
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="501-1000">
                          <p className="text-neutral-400">Graphic Design</p>
                        </SelectItem>
                        <SelectItem value="1000+">
                          <p className="text-neutral-400">Shopify</p>
                        </SelectItem>
                        <SelectItem value="1000+">
                          <p className="text-neutral-400">Wordpress</p>
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
