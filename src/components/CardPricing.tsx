...
const Pricing = () => {
  return (
    <div
      className="w-full mt-10 md:items-center md:justify-center
     antialiased 
    ...
    >
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="grid md:grid-cols-3 gap-6 px-2 md:w-4/5 2xl:w-3/4 cursor-pointer pb-20 items-start ">
